...
def _render_compare_summary(left_metrics, right_metrics) -> str:
    ...
    return "\n".join(
        [
            "Comparison:",
            f"  Left:  {left_metrics.scenario_name} delivery={left_metrics.delivery_rate * 100:.2f}% collisions={left_metrics.collisions} retries={left_metrics.retries}",
            f"  Right: {right_metrics.scenario_name} delivery={right_metrics.delivery_rate * 100:.2f}% collisions={right_metrics.collisions} retries={right_metrics.retries}",
